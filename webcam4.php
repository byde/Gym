...
session_start();
$save = "fotos/" . $_SESSION['idcliente'] . ".jpg";
...
imagedestroy($img);
?>
<img src="<?php echo $save; ?>" /><br />
<a href="javascript:window.close();">Listo</a>  <br />
<a href="javascript:window.history.back();">Volver a Tomar</a>