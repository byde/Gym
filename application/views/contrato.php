...
<strong><?php echo mdate("%d-%m-%Y"); ?></strong>
            ...
            <tr>
                <td colspan="2">
                    ...
                    <ul>
                        ...
                        <li>Proporcionarle un entrenador general certificado (no personal) para el buen desarrollo de su actividad física.</li>
                        <li>Brindarle un servicio de regaderas, de toalla (para regadera o entrenamiento) baño, área de venta de suplementos (con accesoria en ella)</li>
                        <li>Proporcionar servicio de paqueter&iacute;a.</li>
                    ...
                    <ul>
                        ...
                        <li>Acomodar en su lugar el equipo que haya utilizado.</li>
                        <li>No ingerir bebidas alcohólicas o drogas.</li>
            ...
            <tr>
                <td colspan="2" align="center"><i><?php echo $c['nombre']; ?> <?php echo $c['apellidos']; ?></i></td>
            </tr>
        </table>
    </body>
</html>